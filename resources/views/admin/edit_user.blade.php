...
@section('content')
                        ...
                        <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-alt">
                                ...
                                <li class="breadcrumb-item" aria-current="page">
                                    <a class="link-fx" href="javascript:void(0)">Edit</a>
                                </li>
                            </ol>
                        </nav>
                    </div>
            ...
            <div class="content">
                <div class="block block-rounded">
                    ...
                    <div class="block-content block-content-full">
                        <div class="col-lg-8">
                            <form class="mb-5" action="{{ Route('admins.update', $admin->id) }}" method="post"
    ...
    <script type="text/javascript">
        ...
        function validatemobile1(inputtxt) {
            ...
            if (((inputtxt.value).toString().length) < 10) {
                Swal.fire({
                    icon: 'error',
                    title: 'Mobile Input',
        ...
        function myValidate() {
            ...
            if (valid1) {
                ...
                var valid1 = validatemobile1(mobile1);
            }
